...
/**
 * © Copyright 11.01.2026 - 17:29 – Urheberrechtshinweis Alle Inhalte dieser Software, insbesondere der Quellcode, sind
 ...
 */
public record WiringResult(SekunityProvider provider, ShutdownHooks shutdown) {}
