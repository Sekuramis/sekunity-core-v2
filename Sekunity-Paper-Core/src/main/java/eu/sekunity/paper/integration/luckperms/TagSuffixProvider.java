...
/**
 * © Copyright 14.01.2026 - 20:57 – Urheberrechtshinweis Alle Inhalte dieser Software, insbesondere der Quellcode, sind
 ...
 */
public interface TagSuffixProvider
{
	CompletableFuture<String> suffixMm(UUID uuid);
}
